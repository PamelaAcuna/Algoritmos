Algoritmo elecciones
	//cargar en dos arreglos uno con nombre de candidatos y otro con cant de votos obt en una eleccion
	//imprimir los nombres de los 3 cand con mayor cant de votos, asi mismo debera ident el candidato que no haya obtenido
	//por lo menos el 10% de la votacion total para que se mande un mensaje que indique que dicho cand queda fuera de futuras elecciones
	//se debera imprimir el arreglo alfabeticamente de mayor a menor y de menor a mayor
	...
	Para i <- 1 Hasta  max- 2 Hacer
        Para j <- 1 Hasta  max - 2 Hacer
